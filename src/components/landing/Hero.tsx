...
const Hero: FC = () => {
  return (
    <div
      data-testid="hero"
      className="flex flex-col-reverse mt-4 items-center space-y-24 md:space-y-0 md:flex-row md:justify-between md:mt-36"
    >
      <div className="hero__text">
        <h1 className="text-xl text-center leading-6 text-herotext font-semibold md:text-3xl md:text-left md:leading-10 xl:text-4xl">
        ...
        <div className="w-full md:w-[24.75rem] mt-4 md:text-left lg:w-[28.75rem]">
          <h4 className="font-semibold text-center text-sm text-hero px-5 md:px-0 md:text-lg md:text-left xl:text-2xl">
